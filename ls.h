...
static int ls(const char *path, void *user_data, int (*callback)(char *filename, FILETYPE, void *user_data));
...
int ls(const char *dir, void *user_data, int (*callback)(char *filename, FILETYPE, void *user_data)){
	char error[BUFSIZ];
#if defined _WIN32
